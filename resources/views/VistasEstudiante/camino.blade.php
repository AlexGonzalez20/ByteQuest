                            ...
                            <div class="prueba-nodo {{ $prueba->completada ? 'completed' : ($prueba->disponible ? 'available' : 'locked') }}">
                                <div class="nodo-content">
                                    ...
                                    @elseif($prueba->disponible)
                                        <a href="{{ route('pregunta.mostrar', ['prueba_id' => $prueba->id]) }}" class="btn btn-learn">LEARN</a>
                                    @else
                                ...
                                <div class="nodo-content">
                                    <span class="prueba-orden">{{ $prueba->orden }}</span>
                                    >>>>>>> b03a5ae8067c8d32d8f9b7fb3c06fbfec0379ebb
                                    @if ($prueba->completada)
                                        <span class="checkmark">&#10003;</span>
                                    @elseif($prueba->disponible)
                                        <a href="{{ route('pregunta.mostrar', ['prueba_id' => $prueba->id]) }}" class="btn btn-learn">LEARN</a>
...
<<<<<<< HEAD=======@endsection @section('head') <style>
    .path-list {
    width: 100%;
    max-width: 1000px;
    margin: auto;
