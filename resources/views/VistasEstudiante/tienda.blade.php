            ...
            <div class="row justify-content-center">
                    ...
                    <div class="row g-0">
                        <div class="col-12 col-md-6 d-flex flex-column p-4">
                            ...
                            <div class="d-flex align-items-center gap-3 mt-auto">
                                ...
                                @else
                                    <button class="btn btn-secondary px-4 py-2 rounded-pill ms-auto" disabled>
                ...
                <div class="card mb-4" style="background-color: #333661; border: 2px solid #ffd700;">
                    <div class="card-header text-center"
                        style="background: linear-gradient(135deg, #ffd700 0%, #ffed4e 100%); color: #333;">
                        <h6 class="mb-0">
