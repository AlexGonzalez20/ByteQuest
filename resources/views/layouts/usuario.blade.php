                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2">
                            <a class="nav-link @if (Route::currentRouteName() == 'views.UCamino') active @endif"
                                href="{{ route('views.UCamino') }}"><i class='bx bx-git-branch'></i> Camino</a>
                        </li>
                        <li class="nav-item mb-2">
                        ...
                        <li class="nav-item mt-4">
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button class="btn btn-outline-warning w-100" type="submit"><i
                                        class='bx bx-log-out'></i> Salir</button>
                            </form>
                        </li>
                    </ul>
                </div>
