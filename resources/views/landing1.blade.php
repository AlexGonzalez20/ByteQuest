...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
        <div class="container-fluid ms-4 ">
            <a class="navbar-brand" href="{{ route('landing') }}"><span class="byte">Byte</span>Quest</a>
            ...
            <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarNavAltMarkup">
                <div class="navbar-nav ms-4">
                    ...
                    <a class="nav-link ms-4 " href="#about">Sobre nosotros</a>
                    <a class="nav-link ms-4" href="#services">Servicios</a>
                    <a class="nav-link ms-4" href="#portfolio">Proyectos</a>
                    <a class="nav-link ms-4" href="#contact">Contáctanos</a>
                </div>
                <div class="buttons">
