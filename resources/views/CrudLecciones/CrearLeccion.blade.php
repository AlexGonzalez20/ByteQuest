...
<body class="section-padding">
    ...
    <div class="container mt-5 p-4 rounded bg-white bg-opacity-75 shadow">
        <h2 class="mb-4">Añadir leccion</h2>
        ...
        <form method="POST" action="{{ route('lecciones.store') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nombre_leccion" name="nombre_leccion" value="{{ old('nombre_leccion') }}" required>
            </div>
