        ...
        <form method="POST" action="{{ route('preguntas.update', $pregunta->id) }}">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" name="curso_id" id="curso_id" required>
                    ...
                    <option value="{{ $curso->id }}" {{ $pregunta->curso_id == $curso->id ? 'selected' : '' }}>
                        {{ $curso->nombre_curso }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="nivel" name="nivel" min="1" max="10" value="{{ old('nivel', $pregunta->nivel) }}" required>
            </div>
